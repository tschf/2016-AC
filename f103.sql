...
--   Application:     103
--   Name:            Dashboard
--   Date and Time:   23:51 Wednesday March 30, 2016
--   Exported By:     TRENT
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20160330235015'
...
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(3300996559885459)
,p_name=>'Test'
,p_query_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select dbms_random.string(''U'', 12) rand_str',
'from dual',
'connect by level <= 12'))
...
'',
'//needed to behave differently for the tooltips on touch devices',
'//adapted from: http://stackoverflow.com/a/4819886/3476713',
...
,p_last_updated_by=>'TRENT'
,p_last_upd_yyyymmddhh24miss=>'20160330235001'
);
...
,p_triggering_expression=>'this.data && ((this.data.source == "state" && !this.data.isTouchDevice) || this.data.source == "tooltip")'
,p_bind_type=>'bind'
...
'        my: "right center+50%"',
'    },',
'    tooltipClass: ''stateTooltip''',
'});',
'',
'$(''div#colourGrid'').tooltip({',
'    content: function() { ',
'        return $(this).attr(''title''); ',
'    }, ',
'    position: { ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3134928673497802)
,p_name=>'State tooltip clicked: trigger state clicked'
,p_event_sequence=>60
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.stateTooltip'
,p_bind_type=>'live'
,p_bind_event_type=>'click'
,p_da_event_comment=>'Tablet devices behave slightly differently. Tooltips don''t appear until clicking on a node. So, want this to behave so that tablet devices can click on a state to get the tooltip - then only switch to the charts when they click on the tooltip.'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3135009587497803)
,p_event_id=>wwv_flow_api.id(3134928673497802)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'var $tooltipEl = $(this.triggeringElement);',
'var $tooltipContent = $(''.stateTooltipText'', $tooltipEl);',
'var adm1_code = $tooltipContent.data(''adm1_code'');',
'',
'germanMapRenderer.sendStateClicked(adm1_code, ''tooltip'')'))
);
